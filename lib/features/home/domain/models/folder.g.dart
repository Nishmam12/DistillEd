...
extension FolderQueryFilter on QueryBuilder<Folder, Folder, QFilterCondition> {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> sortIndexEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> sortIndexGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> sortIndexLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> sortIndexBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension FolderQuerySortBy on QueryBuilder<Folder, Folder, QSortBy> {
  ...
  QueryBuilder<Folder, Folder, QAfterSortBy> sortBySortIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortIndex', Sort.asc);
    });
  }

  QueryBuilder<Folder, Folder, QAfterSortBy> sortBySortIndexDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderQuerySortThenBy on QueryBuilder<Folder, Folder, QSortThenBy> {
  ...
  QueryBuilder<Folder, Folder, QAfterSortBy> thenBySortIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortIndex', Sort.asc);
    });
  }

  QueryBuilder<Folder, Folder, QAfterSortBy> thenBySortIndexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortIndex', Sort.desc);
    });
  }
...
extension FolderQueryWhereDistinct on QueryBuilder<Folder, Folder, QDistinct> {
  ...
  QueryBuilder<Folder, Folder, QDistinct> distinctBySortIndex() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderQueryProperty on QueryBuilder<Folder, Folder, QQueryProperty> {
  ...
  QueryBuilder<Folder, int, QQueryOperations> sortIndexProperty() {
    return QueryBuilder.apply(this, (query) {
